...
export function RENDER_MOVING_FRAMES_CHUNKS (SELECTED_SHAPEFILE, FARM_ALLOCATIONS) {
   ...
   const movingFrameOptions = {
      katanaSliceDirection: "west",
      chunkifyDirection: "north"
   }


   const katanaSliceDir = movingFrameOptions.katanaSliceDirection


   // let katanaData = getKatanaSlice(katanaSliceDir, percentIngress, SELECTED_SHAPEFILE)
